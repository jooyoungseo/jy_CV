...
\begin{cventries}
    \cventry{Assistant Professor}{School of Information Sciences}{University of Illinois at Urbana-Champaign}{Sep. 2021}{}\vspace{-4.0mm}
    \cventry{Faculty Affiliate}{Illinois Informatics Institute}{University of Illinois at Urbana-Champaign}{Sep. 2021}{}\vspace{-4.0mm}
\end{cventries}
...
\leavevmode\vadjust pre{\hypertarget{ref-scaffold}{}}%
\textbf{Seo, J.}, \& Richard, G. T. (2021). SCAFFOLDing all abilities
into makerspaces: A design framework for universal, accessible, and
intersectionally inclusive making and learning. \emph{Information and
Learning Sciences}. \url{https://doi.org/10.1108/ILS-10-2020-0230}
...
\textbf{Seo, J.}, \& Choi, S. (accepted). Are blind people considered a
...
\leavevmode\vadjust pre{\hypertarget{ref-collabally2022}{}}%
Lee, C. Y. P., Zhang, Z., Herskovitz, J., \textbf{Seo, J.}, \& Guo, A.
(under review). CollabAlly: Accessible collaboration awareness in
document editing. \emph{CHI 2022}.

\leavevmode\vadjust pre{\hypertarget{ref-techtrends2022}{}}%
\textbf{Seo, J.}, Moon, J., Choi, G. W., \& Do, J. (under review). A
methodological review on computational approaches to ethnographic
research in digital learning environments. \emph{TechTrends}.

\leavevmode\vadjust pre{\hypertarget{ref-imageally2022}{}}%
Zhang, Z., Kaushik, S., \textbf{Seo, J.}, Yuan, H., Das, S., Findlater,
L., \ldots{} Wang, Y. (under review). ImageAlly: A human-AI hybrid
approach to support blind people in screening and occluding private
image content. \emph{CHI 2022}.
...
\begin{cventries}
    \cventry{National Leadership Grants for Libraries}{Institute of Museum and Library Services}{United States}{Submitted as a PI}{\begin{cvitems}
\item Promoting Computational Thinking Skills for Blind and Visually Impaired Teens through Accessible Library Makerspaces
\item Requested funding amount: \$554,810.
\end{cvitems}}
    \cventry{Wallace Foundation grant}{Emerging Scholars Program}{International Society of the Learning Sciences}{Submitted as a PI}{\begin{cvitems}
\item Data Accessibilization: Making Data Science Education Accessible for Blind Learners
\item Requested funding amount: \$10,000.
\end{cvitems}}
